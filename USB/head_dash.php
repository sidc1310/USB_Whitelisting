...
<div class="class1" style="margin-left: 35%;background-color:orange;margin-top: 15%;width:30%;border-radius:20px;position: fixed;">
<form action="add_macc.php" method="post">
  <div style="margin-left: 20px; padding: 30px;">
  <button class="button button2">MAC Addresses</button>
</div>
</form>

<form action="add_proo.php" method="post">
  <div style="margin-left: 20px; padding: 30px;">
