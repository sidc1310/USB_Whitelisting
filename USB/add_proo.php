...
<div class="class1" style="margin-left: 35%;margin-top: 10%;position: fixed;background-color: orange;width:40%;border-radius: 20px;">
                    ...
                    <div style="margin-top: 30px;">
                        <label for="inputEmail3">
                            <span style="font-size: 20px;color: red;margin-left: 50px;"><b>Product ID :</b></span></label>
                        
                            <input type="text" name="id" style="width:60%;margin-left: 50px;" pattern="^[0-9A-F]{8}$" class="form-control" id="inputEmail3" placeholder="ID" required>
                       </div>
                       
                        <button class="button button2" name="insert" style="margin-left:50px;margin-top: 30px;">Add Product ID</button>
                        <button class="button button2" name="delete" style="margin-left:50px;margin-top: 30px;">Delete Product ID</button>
                       </form>
                        </div>
                </div>
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST")
      {
        ...
        {
          $id=$_POST['id'];
          $encry=hash('SHA256',$id);

          $query="INSERT INTO product VALUES('$encry')";
         // mysql_select_db("usb");
        ...
        if(isset($_POST['delete']))
        {
          ...
          $query="DELETE from product WHERE id='$encry'";
        //  mysql_select_db("usb");
          $result=mysqli_query($connection,$query);
