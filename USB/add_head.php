...
<body>
  ...
  <!-- <div class="portfolio-experiment"> -->
    <div style="height:800px; position:fixed;margin-top:60px;width:25%;background-color: #2d2d2d;float: left;">
    <ul class="nav1">
  <!-- <li>
    <div class="portfolio-experiment">
...
<div class="class1" style="margin-left: 35%;margin-top: 10%;position: fixed;background-color: orange;width:40%;border-radius: 20px;">
                    ...
                    <div style="margin-top: 10px;">
                        <label for="inputEmail3">
                            ...
                            <div>
                            <input type="text" name="username" style="width:60%;margin-left: 20px;" class="form-control" id="inputEmail3" placeholder="Username" required>
                          </div>
                        ...
                        <button class="button button2" name="insert" style="margin-left:20px;margin-top: 30px;">Add Department Head</button>
                        <button class="button button2" name="delete" style="margin-left:20px;margin-top: 30px;">Delete Department Head</button>
                       </form>
                        </div>
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST")
      {
        if(isset($_POST['insert']))
        {
          ...
          $query="INSERT INTO head VALUES('$username','$password')";
          //mysql_select_db("usb");
        ...
        //  mysql_select_db("usb");
          ...
          $query="DELETE from head WHERE username='$username' && password='$password'";
        //  mysql_select_db("usb");
          $result=mysqli_query($connection,$query);
