...
<div class="class1" style="margin-left: 35%;background-color:orange;margin-top: 5%;width:30%;border-radius:20px;position: fixed;">
<form action="add_mac.php" method="post">
  <div style="margin-left: 20px; padding: 30px;">
  <button class="button button2">MAC Addresses</button>
</div>
</form>

<form action="add_pro.php" method="post">
  <div style="margin-left: 20px; padding: 30px;">
  <button class="button button2">Product ID</button>
</div>
</form>

<form action="add_head.php" method="post">
  <div style="margin-left: 20px;padding: 30px;">
  <button class="button button2">Department Head</button>
</div>
</form>

<form action="change_admin.php" method="post">
  <div style="margin-left: 20px;padding: 30px;">
  <button class="button button2">Change Credentials</button>
</div>
</form>
