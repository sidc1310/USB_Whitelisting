...
<div class="class1" style="margin-left: 35%;margin-top: 10%;position: fixed;background-color: orange;width:40%;border-radius: 20px;">
                    ...
                    <form action="headvalid.php" method="post" class="" style="padding:25px;" role="form">
                    <div style="margin-top: 10px;">
                      <div><span style="font-size: 40px;color: red;margin-left: 40px;"><b> Head Login</b></span></div>
                        ...
                        <button type="submit" name="headlogin" class="button button2" style="margin-left:20px;margin-top: 30px;">Login</button>
