...
<form action="" method="post" class="" style="padding:25px;" role="form">
                    <div style="margin-top: 10px;">
                      <div><span style="font-size: 40px;color: red;margin-left: 40px;"><b> Change Credential</b></span></div>
                        ...
                        <button type="submit" name="update" class="button button2" style="margin-left:20px;margin-top: 30px;">Update</button>
